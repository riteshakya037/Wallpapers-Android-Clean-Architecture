...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.MyViewHolder> {
    ...
    public int getItemCount() {
        ...
        return commentPresenter.getModel().getComments() == null ? 0 : commentPresenter.getModel().getComments().size();
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private String getRelativeTime(Date statusTimeStamp) {
            ...
            if (timeDiff <= 60) {
                return date.getContext().getResources().getQuantityString(R.plurals.time_in_minutes, (int) timeDiff, (int) timeDiff);
            } else if (timeDiff <= 60 * 24) {
                return date.getContext().getResources().getQuantityString(R.plurals.time_in_hours, (int) timeDiff / 60, (int) timeDiff / 60);
            } else {
                return new SimpleDateFormat("hh:mm aa", Locale.getDefault()).format(statusTimeStamp);
            }
        }
