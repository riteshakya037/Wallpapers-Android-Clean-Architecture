...
public abstract class PaginatedBasePresenter<T extends IView, M, K> extends BasePresenter<T, M, K> implements PageController.OnNewPageRequest {
    @NonNull
    ...
    protected PaginatedBasePresenter(@NonNull BaseInteractor interactor, @NonNull IModelDataMapper<K, M> modelDataMapper, IAnalytics analytics) {
