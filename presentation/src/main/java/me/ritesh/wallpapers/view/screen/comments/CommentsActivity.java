...
public class CommentsActivity extends BaseActivity<CommentsModule> implements CommentsActivityView<CommentsModule> {
    public static final String EXTRA_PHOTO = "extra_photo_id";
    @Inject
    IImageLoader iImageLoader;
    @Inject
    CommentPresenter commentPresenter;
    @BindView(R.id.activity_comments_list)
    RecyclerView recyclerView;
    @BindView(R.id.toolbar)
    Toolbar toolbar;
    @BindView(R.id.activity_comments_message_input)
    ...
    @OnClick(R.id.activity_comments_send_button)
    ...
    @Override
    public void onComplete(CommentsModule model) {
    ...
    public void showDialogBox() {
        ...
        View viewInflated = LayoutInflater.from(this).inflate(R.layout.dialog_user_name, null, false);
        // Set up the input
    ...
    @Override
    public void buildComment(String username) {
        String message = messageInput.getText().toString();
