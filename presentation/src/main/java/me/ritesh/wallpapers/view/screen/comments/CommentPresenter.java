...
public class CommentPresenter implements Presenter<CommentsActivityView, CommentsModule> {
    ...
    @Override public CommentsModule getModel() {
        return model;
    }

    @Override public void setModel(CommentsModule model) {
        this.model = model;
    }
    ...
    void getUserName() {
        String userName = PreferenceManager.getDefaultSharedPreferences(application)
