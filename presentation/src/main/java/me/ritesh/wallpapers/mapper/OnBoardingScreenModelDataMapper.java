...
public class OnBoardingScreenModelDataMapper
        implements IModelDataMapper<List<OnBoardingData>, OnBoardingScreenModule> {
    @Inject OnBoardingScreenModelDataMapper() {
    }
